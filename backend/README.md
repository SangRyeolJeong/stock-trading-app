...
미국S&P500(379800)·미국나스닥100(379810)의 운용사 공식 상품·구성종목
자료 URL, 기준일, 상장국과 거래통화를 응답에 포함합니다. 상위 구성종목
...
공식 상품 정보일과 구성종목일 중 하나라도 현재보다 미래이거나 365일을
초과하면 `stale_etf_symbols()` 기반 테스트가 실패합니다. CI 실패 시 운용사
원문을 다시 확인해 수치·기준일·URL을 함께 갱신해야 합니다.
