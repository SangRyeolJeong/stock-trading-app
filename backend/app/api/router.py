...
from app.api.v1 import account, goals, health, markets, paper_orders, preferences, strategies, tax
from app.core.config import get_settings

settings = get_settings()
api_router = APIRouter()
api_router.include_router(health.router)
api_router.include_router(account.router, prefix=settings.api_v1_prefix)
