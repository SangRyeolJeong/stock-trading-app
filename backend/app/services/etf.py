...
ETF_PROFILES = {
    ...
    "SPY": _profile(
        ...
        facts_as_of=date(2026, 8, 30),
        holdings_as_of=date(2026, 8, 27),
        top_holdings=[
            _holding("NVDA", "NVIDIA", "8.29"),
            _holding("AAPL", "Apple", "6.94"),
            _holding("MSFT", "Microsoft", "5.63"),
            _holding("AMZN", "Amazon", "3.77"),
            _holding("GOOGL", "Alphabet A", "3.00"),
            _holding("AVGO", "Broadcom", "2.64"),
            _holding("GOOG", "Alphabet C", "2.40"),
            _holding("META", "Meta Platforms A", "1.88"),
            _holding("MU", "Micron Technology", "1.58"),
            _holding("TSLA", "Tesla", "1.50"),
        ],
        source_url=SPY_URL,
