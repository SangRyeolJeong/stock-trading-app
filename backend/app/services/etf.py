...
ETF_PROFILES = {
    "QQQM": _profile(
        ...
        holdings_as_of=date(2026, 9, 10),
        top_holdings=[
            _holding("NVDA", "NVIDIA", "8.53"),
            _holding("AAPL", "Apple", "7.73"),
            _holding("MSFT", "Microsoft", "5.90"),
            _holding("MU", "Micron Technology", "4.91"),
            _holding("AMZN", "Amazon", "4.37"),
            _holding("AMD", "Advanced Micro Devices", "3.65"),
            _holding("GOOGL", "Alphabet A", "3.12"),
            _holding("META", "Meta Platforms A", "3.08"),
            _holding("TSLA", "Tesla", "2.93"),
            _holding("GOOG", "Alphabet C", "2.91"),
        ],
    ...
    "SPY": _profile(
        ...
        facts_as_of=date(2026, 9, 10),
        holdings_as_of=date(2026, 9, 10),
        top_holdings=[
            _holding("NVDA", "NVIDIA", "8.08"),
            _holding("AAPL", "Apple", "7.33"),
            _holding("MSFT", "Microsoft", "5.59"),
            _holding("AMZN", "Amazon", "3.77"),
            _holding("GOOGL", "Alphabet A", "2.98"),
            _holding("AVGO", "Broadcom", "2.61"),
            _holding("GOOG", "Alphabet C", "2.39"),
            _holding("META", "Meta Platforms A", "2.16"),
            _holding("MU", "Micron Technology", "1.68"),
            _holding("TSLA", "Tesla", "1.56"),
        ],
        source_url=SPY_URL,
